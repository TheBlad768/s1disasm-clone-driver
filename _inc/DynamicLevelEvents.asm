...
DLE_SLZ3boss:
		...
		bsr.w	FindFreeObj
		bne.s	loc_7144
		move.b	#id_BossStarLight,(a1);obID(a1) ; load SLZ boss object
...
DLE_SYZ3main:
		...
		bsr.w	FindFreeObj
		bne.s	locret_71CE
		move.b	#id_BossBlock,(a1); obID(a1) ; load blocks that boss picks up
		addq.b	#2,(v_dle_routine).w
...
DLE_SYZ3boss:
		...
		bsr.w	FindFreeObj
		bne.s	loc_71EC
		move.b	#id_BossSpringYard,(a1); obID(a1) ; load SYZ boss object
		addq.b	#2,(v_dle_routine).w
...
DLE_SBZ2boss:
		...
		bsr.w	FindFreeObj
		bne.s	locret_7298
		move.b	#id_FalseFloor,(a1); obID(a1) ; load collapsing block object
		addq.b	#2,(v_dle_routine).w
...
DLE_SBZ2boss2:
		...
		bsr.w	FindFreeObj
		bne.s	loc_72B0
		move.b	#id_ScrapEggman,(a1); obID(a1) ; load SBZ2 Eggman object
		addq.b	#2,(v_dle_routine).w
...
DLE_FZboss:
		...
		bsr.w	FindFreeObj
		bne.s	loc_7312
		move.b	#id_BossFinal,(a1); obID(a1) ; load FZ boss object
		addq.b	#2,(v_dle_routine).w
		move.b	#1,(f_lockscreen).w ; lock screen
