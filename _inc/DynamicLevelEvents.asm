...
DLE_LZ3:
		...
		lea	(v_lvllayout_fg+((layout_row*5)+12)).w,a1 ; target chunk at row 2, column 6 (zero-based)
		cmpi.w	#$1718,(a1)
		beq.s	.skip_layout				; branch if already modified
		move.w	#$1718,(a1)		; MJ: modify level layout (P128 overwrites two chunks instead of one)
