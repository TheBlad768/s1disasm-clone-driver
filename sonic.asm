...
zeroOffsetOptimization:	equ 0		; if 1, makes a handful of zero-offset instructions smaller
paddingOptimization: 	equ 0		; if 1, removes about 3 KB of various superfluous padding
