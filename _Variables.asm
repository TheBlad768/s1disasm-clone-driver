...
v_collindex:		ds.w	1				; MJ: RAM address for collision index of current level
			ds.b	2				; unused
...
v_top_solid_bit:	ds.b	1				; MJ: top-solid bit to check
v_lrb_solid_bit:	ds.b	1				; MJ: left-right-bottom bit to check
			ds.b	$1A				; unused
