...
bgm__End: equ			(((ptr_musend-MusicIndex)/4)+bgm__First)-1
...
sfx__End: equ			(((ptr_sndend-SoundIndex)/4)+sfx__First)-1

; Special sound effects
spec__First: equ sfx__End+1
sfx_Waterfall: equ		((ptr_sndD0-SpecSoundIndex)/4)+spec__First

spec__End: equ			(((ptr_specend-SpecSoundIndex)/4)+spec__First)-1

; Sound commands
flg__First: equ $F9
specsfx_Stop: equ		((ptr_flgF9-Sound_ExIndex)/2)+flg__First
sfx_Stop: equ			((ptr_flgFA-Sound_ExIndex)/2)+flg__First
bgm_Fade: equ			((ptr_flgFB-Sound_ExIndex)/2)+flg__First
bgm_Sega: equ			((ptr_flgFC-Sound_ExIndex)/2)+flg__First
bgm_Speedup: equ		((ptr_flgFD-Sound_ExIndex)/2)+flg__First
bgm_Slowdown: equ		((ptr_flgFE-Sound_ExIndex)/2)+flg__First
bgm_Stop: equ			((ptr_flgFF-Sound_ExIndex)/2)+flg__First

flg__End: equ			(((ptr_flgend-Sound_ExIndex)/2)+flg__First)-1
