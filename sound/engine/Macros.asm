...
SMPS_MUSIC_METADATA_FORCE_PAL_SPEED equ $00000001				; forces song to play at PAL speeds on PAL consoles for synchronisation (used by drowning theme)
