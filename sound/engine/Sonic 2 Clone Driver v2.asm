...
FMUpdateFreq:
	...
	beq.s	FMPrepareNote_locret	; If modulation is not enabled, return
...
PlaySoundID:	; For the love of god, don't rearrange the order of the groups, it has to be 'music --> SFX --> flags'
	...
	blo.w	CycleSoundQueue_locret		; Return if yes
	...
	bcs.w	CycleSoundQueue_locret		; Return if yes
	cmpi.w	#FlgID__End-FlgID__First,d7	; Is this after commands?
	bhs.w	CycleSoundQueue_locret		; Return if yes
	add.w	d7,d7
...
PSGUpdateVolFX:
	...
	beq.s	PSGDoNoteOn_locret		; Return if it is zero
; loc_7292E:
PSGDoVolFX:
...
cfChangeFMVolume:
	...
	tst.b	SMPS_Track.VoiceControl(a5)	; Is this a PSG track?
	bmi.s	cfSetTempoDivider_locret	; If so, return
	...
	bne.s	cfSetTempoDivider_locret	; If so, return
    endif
	bra.w	SendVoiceTL
...
cfPlaySound:
	moveq	#0,d0
	move.b	(a4)+,d0
	move.w	d0,SMPS_RAM.variables+SMPS_Queue.v_playsnd2(a6)
	rts
; ===========================================================================
