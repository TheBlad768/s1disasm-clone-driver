...
; sub_135E: PlayMusic:
SMPS_QueueSound1:
	tst.w	(Clone_Driver_RAM+SMPS_RAM.variables+SMPS_Queue.v_playsnd1).w
	bne.s	.next
	clr.b	(Clone_Driver_RAM+SMPS_RAM.variables+SMPS_Queue.v_playsnd1+0).w
	move.b	d0,(Clone_Driver_RAM+SMPS_RAM.variables+SMPS_Queue.v_playsnd1+1).w
	rts

.next
	clr.b	(Clone_Driver_RAM+SMPS_RAM.variables+SMPS_Queue.v_playsnd4+0).w
	move.b	d0,(Clone_Driver_RAM+SMPS_RAM.variables+SMPS_Queue.v_playsnd4+1).w
	rts
...
SMPS_QueueSound2Local:
	tst.b	obRender(a0)
	bpl.s	SMPS_QueueSound2_rts	; rts
    endif

; sub_1370: PlaySound:
SMPS_QueueSound2:
	tst.w	(Clone_Driver_RAM+SMPS_RAM.variables+SMPS_Queue.v_playsnd2).w
	bne.s	.next
	clr.b	(Clone_Driver_RAM+SMPS_RAM.variables+SMPS_Queue.v_playsnd2+0).w
	move.b	d0,(Clone_Driver_RAM+SMPS_RAM.variables+SMPS_Queue.v_playsnd2+1).w
	rts
.next
	clr.b	(Clone_Driver_RAM+SMPS_RAM.variables+SMPS_Queue.v_playsnd3+0).w
	move.b	d0,(Clone_Driver_RAM+SMPS_RAM.variables+SMPS_Queue.v_playsnd3+1).w

SMPS_QueueSound2_rts:
	rts
...
SMPS_QueueSound1_Extended:
	tst.w	(Clone_Driver_RAM+SMPS_RAM.variables+SMPS_Queue.v_playsnd1).w
	bne.s	.next
	move.w	d0,(Clone_Driver_RAM+SMPS_RAM.variables+SMPS_Queue.v_playsnd1).w
	rts
.next
	move.w	d0,(Clone_Driver_RAM+SMPS_RAM.variables+SMPS_Queue.v_playsnd4).w
	rts
...
SMPS_QueueSound2Local_Extended:
	tst.b	obRender(a0)
	bpl.s	SMPS_QueueSound2_Extended_rts	; rts
    endif

SMPS_QueueSound2_Extended:
	tst.w	(Clone_Driver_RAM+SMPS_RAM.variables+SMPS_Queue.v_playsnd2).w
	bne.s	.next
	move.w	d0,(Clone_Driver_RAM+SMPS_RAM.variables+SMPS_Queue.v_playsnd2).w
	rts
.next
	move.w	d0,(Clone_Driver_RAM+SMPS_RAM.variables+SMPS_Queue.v_playsnd3).w

SMPS_QueueSound2_Extended_rts:
	rts
