...
Music81:	include "sound/music/Mus - GHZ.asm"
	even
Music82:	include "sound/music/Mus - LZ.asm"
	even
Music83:	include "sound/music/Mus - MZ.asm"
	even
Music84:	include "sound/music/Mus - SLZ.asm"
	even
Music85:	include "sound/music/Mus - SYZ.asm"
	even
Music86:	include "sound/music/Mus - SBZ.asm"
	even
Music87:	include "sound/music/Mus - Invincibility.asm"
	even
Music88:	include "sound/music/Mus - Extra Life.asm"
	even
Music89:	include "sound/music/Mus - Special Stage.asm"
	even
Music8A:	include "sound/music/Mus - Title Screen.asm"
	even
Music8B:	include "sound/music/Mus - Ending.asm"
	even
Music8C:	include "sound/music/Mus - Boss.asm"
	even
Music8D:	include "sound/music/Mus - FZ.asm"
	even
Music8E:	include "sound/music/Mus - Sonic Got Through.asm"
	even
Music8F:	include "sound/music/Mus - Game Over.asm"
	even
Music90:	include "sound/music/Mus - Continue Screen.asm"
	even
Music91:	include "sound/music/Mus - Credits.asm"
	even
Music92:	include "sound/music/Mus - Drowning.asm"
	even
Music93:	include "sound/music/Mus - Get Emerald.asm"
	even
