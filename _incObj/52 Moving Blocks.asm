...
MBlock_Main:	; Routine 0
		...
		move.w	#ArtTile_LZ_Moving_Block|Tile_Pal2,obGfx(a0)
		move.b	#7,obHeight(a0)

loc_FE44:
		cmpi.b	#id_SBZ,(v_zone).w ; check if level is SBZ
		bne.s	loc_FE60
		move.w	#ArtTile_SBZ_Moving_Block_Short|Tile_Pal1,obGfx(a0) ; SBZ specific code (object 5228)
		cmpi.b	#$28,obSubtype(a0) ; is object 5228 ?
		beq.s	loc_FE60	; if yes, branch
		move.w	#ArtTile_SBZ_Moving_Block_Long|Tile_Pal2,obGfx(a0) ; SBZ specific code (object 523x)
