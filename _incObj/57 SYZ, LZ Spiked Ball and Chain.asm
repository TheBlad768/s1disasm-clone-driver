...
SBall_Main:	; Routine 0
		...
		move.b	#col_none,obColType(a0) ; LZ specific code (chain doesn't hurt)
		move.w	#ArtTile_LZ_Spikeball_Chain,obGfx(a0)
...
.fail:
		...
		move.b	#col_16x16|col_hurt,obColType(a0) ; if yes, make last spikeball larger
