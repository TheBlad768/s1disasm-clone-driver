...
bub_time:	equ objoff_32	; time until next bubble spawn
bub_freq:	equ objoff_33	; frequency of bubble spawn
; ===========================================================================
...
.wobble:
		...
		beq.w	.burst
		bclr	#2,obStatus(a1)
		move.b	#sonic_height,obHeight(a1)
		move.b	#sonic_width,obWidth(a1)
		subq.w	#sonic_height-sonic_roll_height,obY(a1)
		bra.w	.burst
; ===========================================================================
