...
Anml_EndVram:	dc.w ArtTile_Ending_Flicky
		dc.w ArtTile_Ending_Flicky
		dc.w ArtTile_Ending_Flicky
		dc.w ArtTile_Ending_Rabbit
		dc.w ArtTile_Ending_Rabbit
		dc.w ArtTile_Ending_Penguin
		dc.w ArtTile_Ending_Penguin
		dc.w ArtTile_Ending_Seal
		dc.w ArtTile_Ending_Pig
		dc.w ArtTile_Ending_Chicken
		dc.w ArtTile_Ending_Squirrel
; ===========================================================================
