...
.door:	spriteHeader
	spritePiece	-$40, -$C, 4, 3, $1AF, 0, 0, 1, 0 ; horizontal sliding door
...
.stomper:	spriteHeader
	spritePiece	-$1C, -$20, 4, 1, $C, 0, 0, 0, 0 ; stomper block with yellow/black stripes
...
.bigdoor:	spriteHeader
	spritePiece	-$80, -$40, 4, 4, 0, 0, 0, 0, 0	; huge diagonal sliding door from SBZ3
