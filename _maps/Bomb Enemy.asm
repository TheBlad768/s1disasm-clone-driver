...
.stand1:	spriteHeader
	spritePiece	-$C, -$F, 3, 3, 0, 0, 0, 0, 0	; bomb standing still
...
.walk1:	spriteHeader
	spritePiece	-$C, -$10, 3, 3, 0, 0, 0, 0, 0	; bomb walking
...
.activate1:	spriteHeader
	spritePiece	-$C, -$F, 3, 3, 0, 0, 0, 0, 0	; bomb during detonation countdown
	spritePiece	-$C, 9, 3, 1, $12, 0, 0, 0, 0
.activate1_End
...
.shrapnel1:	spriteHeader
	spritePiece	-4, -4, 1, 1, $27, 0, 0, 0, 0 ; shrapnel (after it exploded)
.shrapnel1_End
